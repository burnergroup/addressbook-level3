...
https://travis-ci.org/se-edu/addressbook-level3[image:https://travis-ci.org/burnergroup/addressbook-level3.svg?branch=master[Build Status]]
...
[image:https://coveralls.io/repos/github/burnergroup/addressbook-level3/badge.svg?branch=master[%]]
image::Ui.png[]
